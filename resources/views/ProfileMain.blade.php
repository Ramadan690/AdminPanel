...
<script type="text/javascript">
    window.location = "http://localhost:8000/login";
                        ...
                        <li class="nav-item"><a class="nav-link" href="#">Contact</a></li>
                                                ...
                                                <li class="nav-item"><a class="nav-link" href="{{route('profileMain')}}" style="color: #5C96FA;font-weight: bold;">Profile</a></li>
...
<form class="row g-3 needs-validation" novalidate onsubmit="return mySubmitFunction(event)" >
 ...
 <hr>
  ...
  <div class="col-12">
    <center><button class="btn btn-danger" type="submit">Save</button></center>
  </div>
