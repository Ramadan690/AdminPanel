...
">
              ...
              <a class="nav-link" href="{{route('UserConsultation')}}">Manage Users Account</a>   
...
<a class="nav-link" href="{{route('AddUser')}}">Add New User</a>
            ...
            <a class="nav-link" href="{{route('product')}}">Manage Property</a>
          


            <a class="nav-link" href="{{route('EventsForm')}}">Create New Property</a>
...
function verify(ref){
   ...
   if (confirm('Are you sure you want to Authenticate this events with the Reference : '+ref+' ?')) {

    $.ajax(
    {
        url: '{{route("VerifyEvents")}}',
        type: 'get',
        data: {
            "id": ref,
        },
