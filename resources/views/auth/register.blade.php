...
<div class="form-row">
  ...
  <div class="form-group{{ $errors->has('Address') ? ' has-error' : '' }}">
   ...
   <div class="col-md-3 mb-3">
    ...
    <label for="Number">Role as </label>

<select class="form-control" aria-label="Default select example" name="Role" id="Role" style="border: 1px solid #ccc;border-radius: 3px">
  <option value="Member" selected>Tenant</option>
  <option value="Committee">Owner</option>
</select>
