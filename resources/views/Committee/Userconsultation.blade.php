...
<a href="{{ route('EventsFormCom') }}" target="_blank" style="float: right;">
  <button style="font-size: 13px;" type="button" id="add_button" class="btn btn-light"><i class="fas fa-plus-square"></i> <b></b></button>
...
<!--------------------------------------------->
@csrf
<table id="showEvents" class="table table-sm table-striped table-dark table-bordered" style="width:100%">
        <thead>
            <tr>
                <th>Reference</th>
