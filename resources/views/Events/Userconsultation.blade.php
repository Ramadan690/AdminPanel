...
<button style="font-size: 13px;" type="button" id="add_button" class="btn btn-light" onclick="$('#showEvents').DataTable().ajax.reload();"><i class="fas fa-refresh" aria-hidden="true"></i> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-clockwise" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M8 3a5 5 0 1 0 4.546 2.914.5.5 0 0 1 .908-.417A6 6 0 1 1 8 2v1z"/>
  <path d="M8 4.466V.534a.25.25 0 0 1 .41-.192l2.36 1.966c.12.1.12.284 0 .384L8.41 4.658A.25.25 0 0 1 8 4.466z"/>
</svg></button>
<a href="{{ route('EventsFormCom') }}" target="_blank" style="float: right;">
  <button style="font-size: 13px;" type="button" id="add_button" class="btn btn-warning"><i class="fas fa-plus-square"></i> <b></b></button>
...
<!--------------------------------------------->
@csrf
<table id="showEvents" class="table table-sm table-hover table-dark" style="width:100%">
        <thead>
            <tr>
                <th>Reference</th>
                <th class="Title">Title</th>
                <th class="Type">Type</th>
                <th class='Categorie'>Category</th>
                <th class="State">State</th>
                <th class="City">City</th>
                <th class="Street_Address">Street_Address</th>
                <th class="Furnishing">Furnishing</th>
                <th class="price">price</th>
                                <th class="price">Verified</th>
